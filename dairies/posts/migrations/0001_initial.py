# Generated by Django 2.2.16 on 2022-11-06 08:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='Здесь должно быть что-то содержательное', verbose_name='Текст записи')),
        ...
        migrations.AddConstraint(
            model_name='follow',
            constraint=models.UniqueConstraint(fields=('user', 'author'), name='unique_constraint_fail'),
        ),
        migrations.AddConstraint(
            model_name='follow',
